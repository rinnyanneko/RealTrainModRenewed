...
function renderWireStatic(tileEntity, connection, vec, par8, pass)
{
	;
}

function renderWireDynamic(tileEntity, connection, vec, par8, pass)
{
	var x = vec.getX();
	var y = vec.getY();
	var z = vec.getZ();
...
function shouldRenderObject(tileEntity, len, pos, pass)
{
	return true;
}
