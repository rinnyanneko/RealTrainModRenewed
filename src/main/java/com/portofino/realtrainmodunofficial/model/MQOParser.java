...
public class MQOParser {
    ...
    private static MQOModel parseMQO(InputStream is) throws IOException {
        ...
        com.portofino.realtrainmodunofficial.RealTrainModUnofficial.LOGGER.info("Starting MQO parsing");
        ...
        while ((line = reader.readLine()) != null) {
            ...
            lineNum++;
            if (lineNum < 50) {
                com.portofino.realtrainmodunofficial.RealTrainModUnofficial.LOGGER.info("Line {}: {}", lineNum, line);
            }
            if (line.startsWith("Material")) {
                com.portofino.realtrainmodunofficial.RealTrainModUnofficial.LOGGER.info("Found Material section");
                parseMaterials(reader, model);
            } else if (line.startsWith("Vertex")) {
                com.portofino.realtrainmodunofficial.RealTrainModUnofficial.LOGGER.info("Found Vertex section");
                parseVertices(reader, model);
            } else if (line.startsWith("Face")) {
                com.portofino.realtrainmodunofficial.RealTrainModUnofficial.LOGGER.info("Found Face section");
                parseFaces(reader, model);
            } else if (line.startsWith("Object")) {
                com.portofino.realtrainmodunofficial.RealTrainModUnofficial.LOGGER.info("Found Object section");
                parseObject(reader, model);
            }
        }
        
        com.portofino.realtrainmodunofficial.RealTrainModUnofficial.LOGGER.info("MQO parsing complete");
        reader.close();
        return model;
    }
    ...
    private static void parseVertices(BufferedReader reader, MQOModel model) throws IOException {
        ...
        while ((line = reader.readLine()) != null) {
            line = line.trim();
            if (line.equals("}")) {
                com.portofino.realtrainmodunofficial.RealTrainModUnofficial.LOGGER.info("Vertex section ended, parsed {} vertices", vertexCount);
                break;
            }
    ...
    private static void parseFaces(BufferedReader reader, MQOModel model) throws IOException {
        ...
        while ((line = reader.readLine()) != null) {
            line = line.trim();
            if (line.equals("}")) {
                com.portofino.realtrainmodunofficial.RealTrainModUnofficial.LOGGER.info("Face section ended, parsed {} faces", faceCount);
                break;
            }
    ...
    private static void parseObject(BufferedReader reader, MQOModel model) throws IOException {
        ...
        line = line.trim();
        com.portofino.realtrainmodunofficial.RealTrainModUnofficial.LOGGER.info("parseObject called with line: {}", line);
        ...
        model.addGroup(name);
        com.portofino.realtrainmodunofficial.RealTrainModUnofficial.LOGGER.info("Parsing Object: {}", name);
        ...
        while ((line = reader.readLine()) != null) {
            ...
            lineCount++;
            if (lineCount < 10) {
                com.portofino.realtrainmodunofficial.RealTrainModUnofficial.LOGGER.info("Object line {}: {}", lineCount, line);
            }
            ...
            if (line.equals("{")) {
                ...
                braceDepth--;
                if (braceDepth <= 0) {
                    com.portofino.realtrainmodunofficial.RealTrainModUnofficial.LOGGER.info("Object section ended");
                    break;
                }
            }
            ...
            if (line.matches("vertex\\s+\\d+\\s*\\{") || line.matches("Vertex\\s+\\d+\\s*\\{")) {
                com.portofino.realtrainmodunofficial.RealTrainModUnofficial.LOGGER.info("Found vertex section in object: {}", line);
                parseVertices(reader, model);
            } else if (line.matches("face\\s+\\d+\\s*\\{") || line.matches("Face\\s+\\d+\\s*\\{")) {
                com.portofino.realtrainmodunofficial.RealTrainModUnofficial.LOGGER.info("Found face section in object: {}", line);
                parseFaces(reader, model);
            }
        }
    }
