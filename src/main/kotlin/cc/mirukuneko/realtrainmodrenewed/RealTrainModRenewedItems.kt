...
object RealTrainModRenewedItems {
    ...
    @JvmField val RAIL_ITEM: DeferredItem<RailItem> = ITEMS.registerItem("rail", Function { _: Item.Properties -> RailItem() })
    ...
    @JvmField val WIRE_ITEM: DeferredItem<WireItem> = ITEMS.registerItem("wire", Function { _: Item.Properties -> WireItem() })
