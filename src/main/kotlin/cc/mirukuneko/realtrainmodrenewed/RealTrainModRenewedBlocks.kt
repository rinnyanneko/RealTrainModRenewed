...
object RealTrainModRenewedBlocks {
    ...
    @JvmField val SIGNAL_CONVERTER: DeferredBlock<SignalConverterBlock> = BLOCKS.registerBlock("signal_converter", Function { props: BlockBehaviour.Properties -> SignalConverterBlock(props) }, Supplier { BlockBehaviour.Properties.of().sound(SoundType.METAL).strength(1.0f, 6.0f) })
